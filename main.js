...
icareLitApp.innerHTML = `
  <div id="header" class="mx-auto max-w-7xl px-4 py-2 sm:px-6 sm:py-4 lg:px-8 bg-cyan-900">
    <div class="flex items-center justify-between">
      <div class="min-w-0 flex-1">
        <h2 class="text-2xl font-bold leading-7 text-white sm:text-3xl sm:tracking-tight">iCARE-Lit</h2>
        <p class="pt-2 text-sm sm:text-base text-white sm:truncate">Individualized coherent absolute risk estimation of breast cancer</p>
      </div>
      <div class="flex md:mt-0 md:ml-4">
        <a href="https://github.com/jeyabbalas/icare-lit">
          <svg class="h-8 w-8 sm:h-12 sm:w-12 flex-no-shrink fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
