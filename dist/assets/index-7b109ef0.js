    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex md:mt-0 md:ml-4 shrink-0">
        <a href="https://github.com/jeyabbalas/icare-lit">
          <img src="${d}" class="h-10 w-10 sm:h-12 sm:w-12 fill-current" alt="github logo" />
        </a>
      </div>
    </div>
  </div>
...
`;n.addEventListener("submit",r=>{r.preventDefault();const s=new FormData(r.target),i=Object.fromEntries(s.entries());console.log(i),console.log(i.name)});
