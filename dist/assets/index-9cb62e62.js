    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex md:mt-0 md:ml-4 shrink-0">
        <a href="https://github.com/jeyabbalas/icare-lit">
          <img src="${c}" class="h-10 w-10 sm:h-12 sm:w-12 fill-current" alt="github logo" />
        </a>
      </div>
    </div>
  </div>
        ...
        <div class="space-y-6 sm:space-y-5 pt-2 sm:pt-4">
          ...
          <div id="questions" class="space-y-6 sm:space-y-5">
            ...
            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div class="mt-1 sm:col-span-2 sm:mt-0">
                <input type="number" name="age" id="age" min="${a}" max="${l}" step="1" class="block w-full max-w-lg rounded-md border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:max-w-xs sm:text-sm" required>
              </div>
            </div>
            ...
            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div class="mt-1 sm:col-span-2 sm:mt-0">
                <input type="number" name="menarche" id="menarche" min="${a}" max="${l}" step="1" class="block w-full max-w-lg rounded-md border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:max-w-xs sm:text-sm">
              </div>
            </div>
            ...
            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div class="mt-1 sm:col-span-2 sm:mt-0">
                <input type="number" name="age-menopause" id="age-menopause" min="${a}" max="${l}" step="1" class="block w-full max-w-lg rounded-md border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:max-w-xs sm:text-sm">
              </div>
            </div>
            ...
            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div class="mt-1 sm:col-span-2 sm:mt-0">
                <input type="number" name="age-first-child-birth" id="age-first-child-birth" min="${a}" max="${l}" step="1" class="block w-full max-w-lg rounded-md border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:max-w-xs sm:text-sm">
              </div>
            </div>
...
`;m.addEventListener("submit",r=>{r.preventDefault();const t=new FormData(r.target),i=Object.fromEntries(t.entries());console.log(i)});
